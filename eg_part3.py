...
# --- Patch spawn_listener.py to add Dracarys + Dual-Wield hint ---
write("src/cogs/spawn_listener.py", r'''\
import discord
...
# --- Patch hint.py to add Dual-Wield extra line ---
write("src/cogs/hint.py", r'''\
import discord
...
print("Easter Eggs Patch Part 3 applied: spawn_listener.py and hint.py upgraded with Dracarys + Dual-Wield hint.")
